...
public partial class Checkout : System.Web.UI.Page
{
    ...
    public void updateCheckout()
    {
        ...
        else
        {
            ...
            double shippingcost = totalweight * 16 * .46;
    ...
    private void SaveState()
    {
        if (Page.User.Identity.IsAuthenticated)
        {
            Customer old = (Customer)Session["Customer"];
            Customer cust = new Customer(Email.Text, Name.Text, Street.Text, City.Text, State.Text, Zip.Text);
